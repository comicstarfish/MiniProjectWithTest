...
/**
 * PROGRAM TO ESTIMATE THE COST OF PAINTING A HOUSE THE COST INCLUDES: 1. lABOUR
 * COST/SQ_FT 2. COST OF MATERIALS/SQ_FT
 */
public class PaintCostEstimator {
    ...
    public double BasicPaintCost = 150;
    public double PremiumPaintCost = 250;
    double PaintCost;
    double LabourCost = 2;
    double TotalCost;
     ...
     */
    public int heightInput() {                                                      //READS HEIGHT
    ...
    /**
     *
     * @return RETURNS THE AREA OF CEILING IF THE USER WISHES TO PAINT THE
     * CEILING
     */
    ...
    /**
     *
     * @param roomAr IS A PARAMETER WHICH TAKES THE INPUT AS TOTAL ROOM AREA
     * @param type IS A PARAMETER WHICH IS THE TYPE OF PAINT TO BE USED
     * @return RETURNS THE TOTAL COST OF THE PAINT REQUIRED
     */
    public double paintCostEstimate(double roomAr, double type) {
        roomAr = roomArea;
        roomAr = roomAr - ((doors * 21) + (windows * 16));                          //ASSUMING door dimension 7X3ft ;Window dimension 4X4ft
        paintInLitres = roomAr / 100;                                               //To Calculate No.of Litres of paint needed
    ...
    /**
     *
     * @param totalArea IS A PARAMETER THAT TAKES THE INPUT AS TOTAL ROOM AREA
     * @return RETURNS THE TOTAL COST OF LABOUR
     */
    public double labourCostEstimate(double totalArea) {
        totalArea=roomArea;
        return (LabourCost *= totalArea);
    }
     ...
     */
    public double totalCostEstimate(double paint, double labour) {
        paint=PaintCost; labour=LabourCost;
        return (TotalCost = paint + labour);
    }
}
